...
// 각 꼭지점의 4번째를 ctrlpoint1의 각꼭지점의 첫번째로일치시키면 맨위가 같아짐.
...
{// 벡터{r,g,b,a,}를빛을위해사용. light sourcesms 변화될수있다. 
...
void init(void)
{
	glClearColor(0.5, 0.0, 0.0, 0.0); //배경색 검은색으로 설정
	...
	glShadeModel(GL_FLAT); //쉐이딩 방법 설정
